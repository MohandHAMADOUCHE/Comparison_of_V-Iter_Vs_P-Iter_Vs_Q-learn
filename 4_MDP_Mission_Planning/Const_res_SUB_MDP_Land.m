...
P2(7,9,5) = proba_vect_Land(6);

% LANDING (A7)
P2(5,9,6) = proba_vect_Land(6); P2(11,9,6) = proba_vect_Land(6); 

% A20 Hovering 
P2(4,12,7) = proba_vect_Land(6); P2(12,12,7) = proba_vect_Land(6);  

% A24 : NOP
P2(5,5,8) = proba_vect_Land(6); P2(8,8,8) = proba_vect_Land(6);
...
R2(5,2) = reward_vect_Land(2); R2(5,6) = reward_vect_Land(5); % A2 & A7
R2(6,3) = reward_vect_Land(3); 
R2(7,5) = reward_vect_Land(5);  
R2(8,2) = reward_vect_Land(2); R2(8,8) = reward_vect_Land(7); % A24 
