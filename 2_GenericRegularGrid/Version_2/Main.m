...
y_nbr_diff_actions_PI_Ql = different_actions_PI_Ql(x-3);
...
%% saving data
	...
	save('DATAS/DATAS_diff_actions_.mat','x','y_nbr_diff_actions_VI_PI','y_nbr_diff_actions_VI_Ql','y_nbr_diff_actions_PI_Ql') 
